...
class sharefloat_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/sharefloat-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/sharefloat-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function display_plugin_setup_page() {
	    include_once( 'partials/sharefloat-admin-display.php' );
	}
