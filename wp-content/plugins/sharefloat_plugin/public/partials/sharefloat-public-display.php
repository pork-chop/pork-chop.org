 ...
 *
 * @package    sharefloat
 * @subpackage sharefloat/public/partials
 *
 * @uses WP_Query
		...
		<div class="<?php echo $this->plugin_name; ?>">
			<ul>
				<?php if(!empty($fblike) && !empty($facebookurl)) : ?>
					<li>
						<a href="<?php echo $facebookurl ?>" data-share="fblike" title="Follow on Facebook"  target="_blank"><span aria-hidden="true" class="shareicon-fb_like"></a>
					</li>
				<?php endif; ?>
				...
				<?php if(!empty($fbshare)) : ?>
					<li>
						<?php 
						 ...
						 ?>
						<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url . $trackingurl; ?>" title="Share on Facebook" data-share="fbshare" onclick="window.open(this.href,'newWindow','toolbar=no,menubar=no,resizable,width=600,height=400');return false;"><span aria-hidden="true" class="shareicon-fb_share"></span></a></li>
				<?php endif; ?>
				...
				<?php if(!empty($twitter)) : ?>
					<li>
						<?php 
						 ...
						 ?>
						<a href="https://twitter.com/intent/tweet?text=<?php echo $articletitle; ?>&url=<?php echo $url . $trackingurl; if(!empty($twittername)) { echo '&via=' . $twittername; } ?>" onclick="window.open(this.href,'newWindow','toolbar=no,menubar=no,resizable,width=600,height=400');return false;" title="Share on Twitter"><span aria-hidden="true" class="shareicon-twitter"></span></a></li>
				<?php endif; ?>
				...
				<?php if(!empty($linkedin)) : ?>
					<li>
						<?php 
						 ...
						 ?>
						<a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo $url . $trackingurl; ?>&title=<?php echo $articletitle; ?>&summary=<?php echo get_option( 'blogdescription' ); ?>" data-share="linkedin" onclick="window.open(this.href,'newWindow','toolbar=no,menubar=no,resizable,width=600,height=400');return false;" title="Share on LinkedIn"><span aria-hidden="true" class="shareicon-linkedin"></span></a></li>
				<?php endif; ?>
				...
				<?php 
					...
					<li>
						<?php 
						 ...
						 ?>
						<a href="https://pinterest.com/pin/create/button/?url=<?php echo $url . $trackingurl; ?>&media=<?php echo $pagethumb; ?>&description=<?php echo $articletitle; ?>" data-share="pinterest" onclick="window.open(this.href,'newWindow','toolbar=no,menubar=no,resizable,width=800,height=400');return false;" title="Save on Pinterest"><span aria-hidden="true" class="shareicon-pinterest"></span></a></li>
				<?php endif; ?>
				...
				<?php if(!empty($googleplus)) : ?>
					<li>
						<?php 
						 ...
						 ?>
						<a href="https://plus.google.com/share?url=<?php echo $url . $trackingurl; ?>" data-share="googleplus" onclick="window.open(this.href,'newWindow','toolbar=no,menubar=no,resizable,width=600,height=400');return false;" title="Share on Google+"><span aria-hidden="true" class="shareicon-googleplus"></span></a></li>
				<?php endif; ?>
				...
				<?php if(!empty($email)) : ?>
					<li>
						<?php 
						 ...
						 ?>
						<a href="mailto:?&subject=I think you'll enjoy this!&body=Check%20out%20this%20link%20%C2%BB%20<?php echo $articletitle; ?>%20<?php echo $url . $trackingurl; ?>" data-share="email" title="Email to a Friend"><span aria-hidden="true" class="shareicon-email"></span></a></li>
				<?php endif; ?>
			</ul>
